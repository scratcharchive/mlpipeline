...
function JobManager(O) {
	...
	this.startTopLevelJob=function(step,top_level_pipeline_name) {startTopLevelJob(step,top_level_pipeline_name);};
	...
	function startTopLevelJob(step,top_level_pipeline_name) {
		var job=new Job();
