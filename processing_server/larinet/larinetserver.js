...
function QueuedJob() {
	...
	function start(processor_name,inputs,outputs,parameters,resources,opts,callback) {
		...
		mpreq={action:'queue_process',processor_name:processor_name,inputs:inputs,outputs:outputs,parameters:parameters,resources:resources,package_url:opts.package_url||''};
